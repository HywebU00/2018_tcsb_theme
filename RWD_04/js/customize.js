...
$(function () {
  ...
  //
  //推薦資訊-12
  $('.col-md-12 .recommend_link2').slick({
    infinite: true,
    speed: 300,
    slidesToShow: 4,
    slidesToScroll: 1,
  ...
  //推薦資訊-8
  $('.col-md-8 .recommend_link2').slick({
    infinite: true,
    speed: 300,
    slidesToShow: 3,
    slidesToScroll: 1,
  ...
  //推薦資訊-6
  $('.col-md-6 .recommend_link2').slick({
    infinite: true,
    speed: 300,
    slidesToShow: 3,
    slidesToScroll: 1,
  ...
  //推薦資訊-4
  $('.col-md-4 .recommend_link2').slick({
    infinite: true,
    speed: 300,
    slidesToShow: 2,
    slidesToScroll: 1,
  ...
  //
  //推薦資訊-12
  $('.col-md-12 .recommend_link3').slick({
    infinite: true,
    speed: 300,
    slidesToShow: 4,
    slidesToScroll: 1,
  ...
  //推薦資訊-8
  $('.col-md-8 .recommend_link3').slick({
    infinite: true,
    speed: 300,
    slidesToShow: 3,
    slidesToScroll: 1,
  ...
  //推薦資訊-6
  $('.col-md-6 .recommend_link3').slick({
    infinite: true,
    speed: 300,
    slidesToShow: 3,
    slidesToScroll: 1,
  ...
  //推薦資訊-4
  $('.col-md-4 .recommend_link3').slick({
    infinite: true,
    speed: 300,
    slidesToShow: 2,
    slidesToScroll: 1,
  ...
  ////推薦資訊-12
  $('.col-md-12 .recommend_link4').slick({
    infinite: true,
    speed: 300,
    slidesToShow: 4,
    slidesToScroll: 1,
  ...
  //推薦資訊-8
  $('.col-md-8 .recommend_link4').slick({
    infinite: true,
    speed: 300,
    slidesToShow: 3,
    slidesToScroll: 1,
  ...
  //推薦資訊-6
  $('.col-md-6 .recommend_link4').slick({
    infinite: true,
    speed: 300,
    slidesToShow: 3,
    slidesToScroll: 1,
  ...
  //推薦資訊-4
  $('.col-md-4 .recommend_link4').slick({
    infinite: true,
    speed: 300,
    slidesToShow: 2,
    slidesToScroll: 1,
