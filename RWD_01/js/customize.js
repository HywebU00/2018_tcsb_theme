...
$(function () {
  $('.group01').click(function () {
    $('body,html')
      .stop(true, true)
      .animate({ scrollTop: $('.groupA').offset().top - 65 }, 1200, 'easeOutExpo');
  });
  $('.group02').click(function () {
    $('body,html')
      .stop(true, true)
      .animate({ scrollTop: $('.groupB').offset().top - 65 }, 1200, 'easeOutExpo');
  });
  $('.group03').click(function () {
    $('body,html')
      .stop(true, true)
      .animate({ scrollTop: $('.groupC').offset().top - 65 }, 1200, 'easeOutExpo');
  });
  $('.group04').click(function () {
    $('body,html')
      .stop(true, true)
      .animate({ scrollTop: $('.groupD').offset().top - 65 }, 1200, 'easeOutExpo');
  });
  $('.group05').click(function () {
    $('body,html')
      .stop(true, true)
      .animate({ scrollTop: $('.groupE').offset().top - 65 }, 1200, 'easeOutExpo');
  });
  $('.group06').click(function () {
    $('body,html')
      .stop(true, true)
      .animate({ scrollTop: $('.groupF').offset().top - 65 }, 1200, 'easeOutExpo');
  });
  $('.group07').click(function () {
    $('body,html')
      .stop(true, true)
      .animate({ scrollTop: $('.groupG').offset().top - 65 }, 1200, 'easeOutExpo');
  });
  $('.group08').click(function () {
    $('body,html')
      .stop(true, true)
      .animate({ scrollTop: $('.groupH').offset().top - 65 }, 1200, 'easeOutExpo');
  });
  $('.group09').click(function () {
    $('body,html')
      .stop(true, true)
      .animate({ scrollTop: $('.groupI').offset().top - 65 }, 1200, 'easeOutExpo');
  });
